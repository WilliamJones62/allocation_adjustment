class AllocationsController < ApplicationController
  ...
  def index
    ...
    @allocations = Allocation.where("created_at > '2017-11-30 23:59:59'")
  end
  ...
  def new
    ...
    @sku = [ " ", "CHICAP001", "CHICAP002", "CHICAP003", "CHICAP006", "GEENAT001", "GEENAT002", "GEENAT003", "GEENAT004", "GEENAT005", "GEENAT006", "TURHER001",
      "TURHER002", "TURHER003", "TURNAT003", "TURNAT004", "TURNAT005", "TURNAT012", "TURNAT013", "TURNAT014", "TURNAT015", "TURNAT016", "TURNAT017", "TURNAT018", "TURNAT019", "TURNAT020", "TURNAT021", "TURORG002", "TURORG003",
